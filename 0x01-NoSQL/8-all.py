...
The function returns an empty list if there are no documents in the collection.
"""
...
def list_all(mongo_collection: Collection) -> List[Dict]:
    ...
    Parameters:
    mongo_collection (Collection): The pymongo collection object from which to list/retrieve documents.
    
    Returns:
    List[Dict]: A list of dictionaries representing all the documents in the collection.
                Returns an empty list if the collection is empty, has no documents or not provided.
    """
